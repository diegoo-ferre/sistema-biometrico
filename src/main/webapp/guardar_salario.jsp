...
<%
                ...
                // Obtenemos mes y año actual automáticamente del sistema
                ...
                ps = con.prepareStatement(
                    "insert into salarios (persona_id, sueldo_base, porcentaje_descuento, motivo_descuento, monto_descuento, sueldo_final, fecha_registro, mes, anio) values (?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP, ?, ?)"
                );
                ...
                ps.setInt(7, mesActual);
                ps.setInt(8, anioActual);
