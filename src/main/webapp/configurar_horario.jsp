...
<div class="contenedor">
    <h2>Configuración de Horario <img src="img/reloj.png" class="icon7"></img></h2>
    <%
    Connection con = null;
    try {
        ...
        if ("POST".equalsIgnoreCase(request.getMethod())) {
            ...
            PreparedStatement ps = con.prepareStatement("UPDATE configuracion_horario SET hora_entrada = ?, hora_salida = ?, tolerancia_minutos = ? WHERE id = 1");
