...
<head>
    ...
    <title>Configuración de Horario</title>
...
<div class="contenedor">
    <h2>Configuración de Entrada <img src="img/reloj.png" class="icon7"></img></h2>
    <%
    Connection con = null;
    try {
        ...
        if ("POST".equalsIgnoreCase(request.getMethod())) {
            ...
            // Corrección: Nombre de tabla y columnas actualizado
            PreparedStatement ps = con.prepareStatement("UPDATE configuracion_horario SET hora_entrada = ?, tolerancia_minutos = ? WHERE id = 1");
