...
try {
    ...
    // Forzar zona horaria a Paraguay
...
<%
    ...
    while (rs.next()) {
        ...
        // Obtener hora y ajustar -3 horas (de UTC a Paraguay)
        Time horaEntradaDb = rs.getTime("hora_entrada");
        String horaEntradaMostrada = "";
        LocalTime entrada = null;
        
        if (horaEntradaDb != null) {
            entrada = horaEntradaDb.toLocalTime().minusHours(3);
            horaEntradaMostrada = entrada.toString();
        }

        // Lo mismo para la hora de salida
        Time horaSalidaDb = rs.getTime("hora_salida");
        String horaSalidaMostrada = "";
        if (horaSalidaDb != null) {
            horaSalidaMostrada = horaSalidaDb.toLocalTime().minusHours(3).toString();
        }
...
%>
            <tr>
                ...
                <td><%= horaEntradaMostrada %></td>
                <td><%= horaSalidaMostrada %></td>
