...
try {
    ...
    // Guardamos con fecha del periodo (dia 1) + hora actual
    String sql = "INSERT INTO salarios (persona_id, sueldo_base, porcentaje_descuento, monto_descuento, sueldo_final, motivo_descuento, fecha_registro) " +
                 "VALUES (?, ?, 0, ?, ?, ?, (make_date(?, ?, 1) + (CURRENT_TIME AT TIME ZONE 'UTC' AT TIME ZONE 'America/Asuncion')::time))";
    ...
    ps.setString(5, (motivo == null || motivo.trim().isEmpty()) ? "Sin detalles" : motivo);
    ps.setInt(6, Integer.parseInt(anio));
    ps.setInt(7, Integer.parseInt(mes));
