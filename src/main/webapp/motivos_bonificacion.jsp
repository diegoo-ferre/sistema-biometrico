...
<div class="contenedor">
    <h2>Configuración de Bonificaciones <img src="img/agregar.png" class="icon5"></h2>
...
ResultSet rs = null;
String mensaje = null;
String tipoAlerta = "alert-success"; // Por defecto éxito
...
try {
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        if ("guardar".equals(accion)) {
            ...
            if (valor < 0) {
                mensaje = "Error: El valor de la bonificación no puede ser negativo.";
...
<% if (mensaje != null) { %><div class="alert <%= tipoAlerta %>"><%= mensaje %></div><% } %>
    ...
    <form method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <label>Valor</label>
                <!-- Se añade min="0" como barrera adicional en el navegador -->
