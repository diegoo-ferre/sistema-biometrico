...
<head>
    ...
    <style>
        ...
        .camera-box { margin: 0 auto 25px auto; width: 100%; max-width: 520px; border-radius: 22px; overflow: hidden; border: 3px solid rgba(255,255,255,0.08); box-shadow: 0 8px 25px rgba(0,0,0,0.5); background: #000; }
        video { width: 100%; display: block; }
        .estado-camara { margin-top: 10px; margin-bottom: 20px; font-size: 15px; color: #cfd8dc; }
        ...
        .btn-admin { background: linear-gradient(45deg, #5e35b1, #8e24aa); }
