...
<head>
    ...
    <style>
        ...
        .btn-guardar { background: linear-gradient(40deg, #4225a3, #000738); border: none; color: white; padding: 8px 20px; border-radius: 15px; font-weight: bold; margin-bottom: 5px; }
        .btn-pdf { background: linear-gradient(40deg, #e74c3c, #c0392b); border: none; color: white; padding: 8px 20px; border-radius: 15px; font-weight: bold; text-decoration: none; display: inline-block; }
        .btn-pdf:hover { color: white; text-decoration: none; opacity: 0.9; }
        ...
        .icon9{ filter: brightness(0) invert(1); }
    </style>
</head>
<body>

<div class="contenedor">
    <h2>Liquidación Mensual <img src="img/liquidacion.png" class="icon9"></img></h2>
    ...
    <table>
        ...
        %>
            <tr>
                ...
                <td>
    <form action="procesar_guardar_liquidacion.jsp" method="POST" style="margin: 0; display: inline-block;">
    ...
    <a href="prueba_pdf.jsp?id=<%= personaId %>&t=<%= System.currentTimeMillis() %>" class="btn btn-danger btn-sm" style="border-radius: 15px; font-weight: bold; margin-top: 2px;">PDF</a>
</td>
            </tr>
        <%
                }
