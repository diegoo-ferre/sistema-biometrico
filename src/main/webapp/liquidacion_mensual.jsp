...
<div class="contenedor">
    ...
    <form method="get" action="liquidacion_mensual.jsp" class="filtros">
    ...
    <table>
        ...
        %>
            <tr>
                ...
                <td>
                <form action="guardar_liquidacion.jsp" method="post" onsubmit="this.querySelector('button').disabled = true;">
